...
Feature: MobileOffer2Options
  ...
  Scenario Outline: Mobile <Offer> Offer With 2 Options
    ...
    And I should see "Recurring Gross Charge" label for "<Option1>" option that contains corresponding string
    And I should see "Recurring Net Charge" label for "<Option1>" option that contains corresponding string
    ...
    @TestCaseCode:TC0022 @Xray:TES-99
    Examples: DM Alowance Roaming World 30 Voice
      | Name        | Email           | Offer     | FeatureCategory1                     | FeatureCategory2                    | Option1                                  | Option2                                        |
      | HT Infonova | roxoft@mail.com | Digital M | Mobile Digital Roaming Voice Options | Mobile Digital Roaming Data Options | Digital Allowance Roaming World 30 Voice | Digital Roaming World Data 2 GB Monthly Charge |