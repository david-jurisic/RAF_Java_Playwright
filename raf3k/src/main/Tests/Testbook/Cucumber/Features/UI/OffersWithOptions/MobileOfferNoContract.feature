...
Feature: MobileOfferNoContract
  ...
  Scenario Outline: Mobile <Offer> Offer With <Option> Option
    ...
    And I select "<FeatureCategory>" option in "Feature Filter" list on left part of the page
    ...
    @TestCaseCode:TC0024 @Xray:TES-99
    Examples: DL NOUO PP3 Sales Discount 12 Months
      | Name        | Email           | Offer     | FeatureCategory             | Option                          |
      | HT Infonova | roxoft@mail.com | Digital L | No Contract Sales Discounts | DL PP3 Sales Discount 12 Months |